...
public class PaisajeVoL implements Serializable {
    ...
    public PaisajeVoL(String nameCity, String information, String descriptionDetails,
                      int imageResource, int imageResourceDetails) {
